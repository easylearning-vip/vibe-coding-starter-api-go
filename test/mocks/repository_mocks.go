...
func (m *MockProductCategoryRepository) GetCategoryTree(ctx context.Context) ([]*model.ProductCategory, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockProductRepository) GetByCategoryWithSubcategories(ctx context.Context, categoryID uint, opts repository.ListOptions) ([]*model.Product, int64, error) {
	args := m.Called(ctx, categoryID, opts)
	if args.Get(0) == nil {
		return nil, args.Get(1).(int64), args.Error(2)
	}
...
func (m *MockProductRepository) GetHotSellingProducts(ctx context.Context, limit int) ([]*model.Product, error) {
...
func (m *MockProductRepository) GetByPriceRange(ctx context.Context, minPrice, maxPrice float64, opts repository.ListOptions) ([]*model.Product, int64, error) {
...
func (m *MockProductRepository) SearchProducts(ctx context.Context, query string, opts repository.ListOptions) ([]*model.Product, int64, error) {
	args := m.Called(ctx, query, opts)
	if args.Get(0) == nil {
		return nil, args.Get(1).(int64), args.Error(2)
	}
...
func (m *MockProductRepository) GetLowStockProducts(ctx context.Context) ([]*model.Product, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockProductRepository) GetProductsByStatus(ctx context.Context, isActive bool, opts repository.ListOptions) ([]*model.Product, int64, error) {
